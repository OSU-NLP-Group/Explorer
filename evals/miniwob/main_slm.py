...
def parse_opt():
    ...
    # parser.add_argument("--use-old-js", action="store_true", help='use older version of page_script.js')
    # parser.add_argument("--add-class-id", action="store_true", help='add class and id to acc tree')
    parser.add_argument("--add-class", action="store_true", help='add class to acc tree')
    parser.add_argument("--omit-task-desc-ele", action="store_true", help='omit task desc element', default=True)
    ...
    # parser.add_argument("--add-class-id-subset", action="store_true", help='add class for subset of tasks')
        ...
        while step_id < step:
            ...
            if not opt.no_multiple_parse:
                ...
                if response:
                    ...
                    # transform html to acc tree
                    som_image_obs, acc_tree, rects = image_processor.process_new(browser_env.page, browser_env.page.client, intent=None, add_class=opt.add_class, omit_task_desc_ele=False, goal=goal, opt=opt)
